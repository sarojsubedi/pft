    ...
    <>
      <div className="flex flex-col gap-8 p-4 min-w-1/2">
        <div>
          ...
          <div className="flex flex-col p-4 border border-gray-300 rounded-2xl max-w-1/2">
            Last 6 months
            <span className="font-bold">Rs. {balance}</span>
            <img src="https://placehold.co/400x200" alt="chart" />
          </div>
        </div>
        <div>
          <h3 className="text-xl font-bold">Spending by Category</h3>
          <div className="flex flex-col mt-4 p-4 border border-gray-300 rounded-2xl max-w-1/2">
            <img src="https://placehold.co/400x200" alt="chart" />
          </div>
        </div>
        <div>
